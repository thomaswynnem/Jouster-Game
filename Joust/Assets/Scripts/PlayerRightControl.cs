...
public class PlayerRightController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject.Find("OppositionCharacter").GetComponent<OpponentLeftControls>().enabled = false;
    ...
    void FixedUpdate()
    {
        ...
        if (opened) {
            ...
            if (!duringthrust && (powerMoment ==0 || power == 1)) {
        ...
        if (horizantalInput > 0) {
            ...
            opened = true;
            GameObject.Find("OppositionCharacter").GetComponent<OpponentLeftControls>().enabled = true;
    ...
    private void OnTriggerEnter2D(Collider2D other) {
        ...
        Debug.Log("Triggered");
        if (other.CompareTag("Border2")) {

            GameObject.Find("SceneManager").GetComponent<JoustSceneManager>().Left();
